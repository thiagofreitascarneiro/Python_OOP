...
função é construir o objeto a prtir da classe.
...
ATENÇÂO! Por mais que possamos criar nossas próprias funções utilizando dunder (underline no ínicio e no fim)
...
# Métodos são escritos em letras minúsculas. Se o nome for composto, o nome terá as palavras
...
user1 = Usuario('Agenlina', 'Jolie', 'angelina@gmail.com', '123456')
...
# Métodos de Classe em Python são conhecidos como métodos estatico em outras linguagens.
