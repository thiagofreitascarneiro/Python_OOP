...
Classes nada mais são do que modelos dos objetos do mundo real sendo representados
computacionalmente.
...
OBS: Quando nomeamos uma classe em Python utilizamos por conveção o nome com inicial em
...
de classe, atributos, métodos, arquivos, diretórios e etc.
